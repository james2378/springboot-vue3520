<template>
	<el-main class="bg">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','test_score') || $check_field('add','test_score') || $check_field('set','test_score')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="考试分数" prop="test_score">
					<el-input id="test_score" v-model="form_sub['test_score']" placeholder="请输入考试分数"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','test_score')) || (!form_sub['student_user_id'] && $check_field('add','test_score'))"></el-input>
					<div v-else-if="$check_field('get','test_score')">{{form_sub['test_score']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','japanese_level') || $check_field('add','japanese_level') || $check_field('set','japanese_level')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="日语等级" prop="japanese_level">
					<el-input id="japanese_level" v-model="form_sub['japanese_level']" placeholder="请输入日语等级"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','japanese_level')) || (!form_sub['student_user_id'] && $check_field('add','japanese_level'))"></el-input>
					<div v-else-if="$check_field('get','japanese_level')">{{form_sub['japanese_level']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','toeic_score') || $check_field('add','toeic_score') || $check_field('set','toeic_score')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="托业分数" prop="toeic_score">
					<el-input id="toeic_score" v-model="form_sub['toeic_score']" placeholder="请输入托业分数"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','toeic_score')) || (!form_sub['student_user_id'] && $check_field('add','toeic_score'))"></el-input>
					<div v-else-if="$check_field('get','toeic_score')">{{form_sub['toeic_score']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','intended_major') || $check_field('add','intended_major') || $check_field('set','intended_major')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="意向专业" prop="intended_major">
					<el-input id="intended_major" v-model="form_sub['intended_major']" placeholder="请输入意向专业"
							  v-if="user_group === '管理员' || (form_sub['student_user_id'] && $check_field('set','intended_major')) || (!form_sub['student_user_id'] && $check_field('add','intended_major'))"></el-input>
					<div v-else-if="$check_field('get','intended_major')">{{form_sub['intended_major']}}</div>
				</el-form-item>
			</el-col>
			<el-col :xs="24" :sm="12" :lg="8">
				<el-form-item>
		...
		data() {
			return {
				...
				disabledObj:{
					...
					"test_score_isDisabled": false,
					"japanese_level_isDisabled": false,
					"toeic_score_isDisabled": false,
					"intended_major_isDisabled": false,
				},
