<template>
	<div class="diy_details_box diy_div_school_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
						...
						<!-- 图片 -->
							...
							<div class="details_btn_wrap">
								<button class="btn btn-primary details_btn" v-if="$check_action('/school_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
