...
const routes = [
	...
	//学校信息列表路由
	{
		path: '/school_information/list',
		name: '/school_information_list',
		component: () => import('../views/school_information/list.vue')
	},
	//学校信息详情路由
	{
		path: '/school_information/details',
		name: '/school_information_details',
		component: () => import('../views/school_information/details.vue')
	},
...
router.afterEach((to, from, next) => {
	let title = "《升学日》日本大学信息及院校推荐网站-home";
	document.title = title;
	document.logo = "《升学日》日本大学信息及院校推荐网站"
})
